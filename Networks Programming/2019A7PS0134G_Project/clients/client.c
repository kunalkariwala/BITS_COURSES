...
int main(int argc, char const* argv[]){
  ...
  while(1){
    ...
    printf("[+]Enter the name of the file you want to access with extension, type quit if you want to disconnect\n");
    ...
    FILE* filePointer = fopen(filename,"a+b");
    if(filePointer == NULL){
    ...
    while(1){
      ...
      printf("Received - %s\n",buffer);
      if(strcmp(buffer,"endoffile") == 0){break;}
